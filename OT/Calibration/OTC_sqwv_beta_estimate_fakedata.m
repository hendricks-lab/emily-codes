...
datdir='/Users/emilyprowse/Documents/McGill/Hendricks_Lab/Data/HEK_OT/';
% datdir = '/Volumes/Emily_htt_2/20210810_OT_WT_fn_early_to_late/'; % defining the path to where the transferfunction.mat files are
addpath(datdir)

%set filename to multiharmonic measurement
flist{1} = {'14.08.21-11.03-TF-fake_OT_data_in_phase.mat'}; %name of file to load
...
ktrap_guess = 0.01; %0.05; %0.1; % manual input
kcyt0_guess = 0.01; % manual input
kcyt1_guess = 0.0001; %0.002; % manual input
...
betalb = 0.5; %lower bound on beta Emily changed from 0.9 
betaub = 1.5; %upper bound on beta Emily changed from 1.1
...
Fexc_PS_reject=[Fexcall];%600:760];%1700:2200,2920,2815,5250,6500:6580,7600:7650];%,random_noise,random_noise2,random_noise4,random_noise9,2815,3853,random_noise10,random_noise11];%random_noise2,random_noise8,random_noise5];
...
set(gca,'Xlim',[1e-1 1e4]), set(gca,'Ylim',[1e-12 1e-2]); % this is where the zoom in happens
